...
var image_html = '<img src=\"https://openweathermap.org/img/w/' + jsObjectForecast.list[i].weather[0].icon + '.png\" alt=\"' + jsObjectForecast.list[i].weather[0].description + '\"/>';
document.getElementById(number).innerText = html;
document.getElementById(image).innerText = image_html;
}
}
{/* <img src="images/5day.jpg" alt="5 day forecast" /> */}
